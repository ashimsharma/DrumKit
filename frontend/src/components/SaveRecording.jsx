        ...
        <>
            ...
            <div className="w-1/5 absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl bg-slate-800 text-center brightness-125 z-20 shadow-md shadow-slate-600">
                <div className="p-2">
                    ...
                    <p className="text-red-600 text-sm w-full h-3">{errors.recordingName && errors.recordingName.message}</p>
                </div>
                <button className="bg-blue-600 p-2 rounded-lg m-2 hover:bg-blue-700" onClick={handleSubmit(handleSaveClick)}>Save</button>
                <button className="bg-blue-600 p-2 rounded-lg m-2 hover:bg-blue-700" onClick={handleCancelClick}>Cancel</button>
            </div>
        </>
    )
}