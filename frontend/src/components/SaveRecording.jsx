...
export default function SaveRecording() {
    ...
    return (
        <>
            ...
            <div className="w-1/5 lg:w-1/2 absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl bg-slate-800 text-center brightness-125 z-20 ring-2 ring-blue-500">
                <div className="p-2">
