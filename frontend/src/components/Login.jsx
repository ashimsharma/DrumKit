...
export default function Login() {
    ...
    return (
        <>
            <div className="absolute bg-gray-400 w-1/2 h-full blur-3xl opacity-70 lg:hidden"></div>
            <h1 className="absolute top-10 left-4 text-white font-bold text-3xl lg:hidden">Drum Kit Image</h1>
            <div className="grid grid-cols-2 bg-slate min-h-screen lg:block m-0 h-full min-w-screen w-full">
                ...
                <div className="bg-slate-800 w-full h-full">
                    ...
                    <div className="p-24">
                        ...
                        <p className="text-white text-center p-4 my-12">Don't have an account? <button className="bg-none underline text-blue-700" onClick={navigateToSignup}>Create One</button></p>
                    </div>
                </div>
            </div>
        </>
